document.addEventListener('DOMContentLoaded', () => {
  ...
  const collapseBtn = document.getElementById('collapse-experience');
  if (loadMoreBtn) {
    const expCards = Array.from(document.querySelectorAll('#exp-grid .exp-card'));
  ...
  const collapseProjectsBtn = document.getElementById('collapse-projects');
  if (loadMoreProjectsBtn) {
    const projectCards = Array.from(document.querySelectorAll('#projects .projects-grid .project-card'));
  ...
  const loadMoreMarketingBtn = document.getElementById('load-more-marketing');
  const collapseMarketingBtn = document.getElementById('collapse-marketing');
  if (loadMoreMarketingBtn) {
    const marketingCards = Array.from(document.querySelectorAll('#projects .marketing-grid .proj-alt-card'));
